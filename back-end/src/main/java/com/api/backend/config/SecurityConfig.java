    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                                ...
                                .requestMatchers(HttpMethod.POST, "/usuario/create").hasAnyAuthority("ROLE_Chefe", "ROLE_Admin")
...
//                        .requestMatchers("/tipo-ocorrencia/**").hasAnyAuthority("ROLE_Chefe", "ROLE_Admin", "ROLE_Analista")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:5174", "https://cbmpex.netlify.app"));
